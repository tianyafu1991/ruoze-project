...
public class HBaseCRUD {
    ...
    public static void main(String[] args)  throws Exception{
        ...
        //createTable("ruozedata:person",new String[]{"user","work"});
        //putRecord("ruozedata:person","row1","user","id","1");
        //putRecord("ruozedata:person","row1","user","name","jepson");

        //getOneRecord("ruozedata:person","row1");
        //getAllRecord("ruozedata:person");
        deleteRecord("ruozedata:person","row1");
