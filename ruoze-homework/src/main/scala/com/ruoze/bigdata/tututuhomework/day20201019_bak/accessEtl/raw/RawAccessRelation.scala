package com.ruoze.bigdata.tututuhomework.day20201019_bak.accessEtl.raw
...
case class RawAccessRelation(@transient val sqlContext: SQLContext, path: String, userSchema: StructType)
